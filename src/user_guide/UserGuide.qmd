...
::: {.callout-note}
This page is still work in progress and therefore no link has been created to it
:::
...
::: {.callout-note}
Only the frontend part of the page is currently operational, Please refer to 
:::

To generate a course access code 
