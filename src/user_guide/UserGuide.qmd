...
::: {.callout-note collapse="true"}
Only, frontend implementation are deployed in this release.  Their is no backend support for submitting questions to the super-admin.
:::
...
The left portion of the report page highlights key parameter 
