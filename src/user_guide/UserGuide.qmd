...
Super Admin :
  - No login necessary Navigate to the following [link](https://gray-bush-0c1bf981e.6.azurestaticapps.net/super-admin)
...
::: {.callout-note}
This page is still work in progress and therefore adding classes is currently not supported.
:::
...
To change an particular detail about a course such as its name:

1. Click the three dots () on the top right of the course card you are interested in editing.
2. Go to the detail you would like to change.
